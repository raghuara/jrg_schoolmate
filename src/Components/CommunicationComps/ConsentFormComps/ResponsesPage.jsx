    ...
    return (
        <Box sx={{ width: "100%", }}>
            ...
            <Box sx={{ backgroundColor: "#f2f2f2", px: 2, borderRadius: "10px 10px 10px 0px", borderBottom: "1px solid #ddd", }}>
                <Grid container>
                    <Grid item xs={6} sm={6} md={3} lg={4} sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Grid item xs={12} sm={12} md={3} lg={1.5} sx={{ display: "flex", justifyContent: "end", alignItems: "center", px: 1 }}>
                        <Box>
