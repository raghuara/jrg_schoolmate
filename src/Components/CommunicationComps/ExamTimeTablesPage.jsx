import { Autocomplete, Box, Button, DialogActions, Dialog, Fab, Grid, IconButton, Paper, Switch, TextField, Typography, Grid2, ToggleButtonGroup, ToggleButton, styled } from "@mui/material";
    ...
    useEffect(() => {
        if (grades && grades.length > 0) {
            ...
            if (defaultGrade) {
                ...
                setExamOptions(Array.isArray(defaultGrade.exams) ? defaultGrade.exams : []);
                setSelectedExam(defaultGrade.exams?.[0] || '');
            }
        }
    }, [grades]);
    ...
    return (
        <Box sx={{ width: "100%", }}>
            ...
            <Box sx={{ backgroundColor: "#f2f2f2", px: 2, py: 1, borderRadius: "10px 10px 10px 0px",  borderBottom:"1px solid #ddd",}}>
                <Grid container>
                    <Grid item xs={6} sm={6} md={3} lg={userType === "teacher" ? 3 : 3}  sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Grid item xs={12} sm={12} md={3} lg={4} sx={{ display: "flex", justifyContent: "center", alignItems: "center", pb: 1 }}>
                    ...
                    <Grid item xs={6} sm={6} md={3} lg={2.5} sx={{ display: "flex", justifyContent: "end", alignItems: "center" }}>
                        {userType !== "teacher" &&
                            <Button
