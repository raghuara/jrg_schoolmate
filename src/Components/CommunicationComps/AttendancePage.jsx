...
import { attendanceSpecific, attendanceTable, barchart, DashboardTeachersAttendance, piechart, sectionsDropdown } from "../../Api/Api";
...
import AddAttendancePage from "./AttendanceComps/AddAttendancePage";
...
export default function AttendancePage() {
    ...
    const handleAttendancePopupOpen = () => setOpenAttendancePopup(true);
    const handleAttendancePopupClose = () => setOpenAttendancePopup(false);
                ...
                <Grid container mb={2}>
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={6}>
                        <Box sx={{ backgroundColor: "#fff", mx: 2, mt: 2, px: 2, pb: 2, borderRadius: "5px", boxShadow: "0px 2px 4px 0px rgba(0,0,0,0.17)" }}>
                            <Typography pt={1} sx={{ fontWeight: "550", fontSize: "18px" }}>
                                Student Counts <span style={{ fontSize: "12px" }}>Overall</span>
                            </Typography>
                            <Grid container spacing={2}>
                ...
                <Box p={3}>
                    ...
                    <Grid container>
                        ...
                        <Grid item xs={12} sm={12} md={9} lg={9}>
                            ...
                            <Box sx={{ display: "flex", border: "1px solid #eee", width: "75px" }}>
