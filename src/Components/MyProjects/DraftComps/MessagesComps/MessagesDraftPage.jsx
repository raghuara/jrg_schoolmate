import { Autocomplete, Box, Button, createTheme, Dialog, DialogActions, DialogContent, DialogTitle, Fab, Grid, Grid2, IconButton, InputAdornment, Paper, Switch, TextField, ThemeProvider, Typography } from "@mui/material";
                                        ...
                                        .map((messageItem) => {
                                            ...
                                            return (
                                                <Grid item xs={12} sm={12} md={12} lg={6} key={messageItem.id}>
                                                    ...
                                                    >
                                                        <Grid container>
                                                            <Grid item xs={12} sm={12} lg={12} sx={{ display: "flex", alignItems: "center" }}>
                                                                <Box>
