import { Autocomplete, Box, Button, createTheme, Dialog, DialogActions, DialogContent, DialogTitle, Fab, Grid2, IconButton, InputAdornment, Paper, styled, Switch, TextField, ThemeProvider, Typography } from "@mui/material";
    ...
    return (
        <Box sx={{ width: "100%", }}>
            ...
            <Box sx={{ backgroundColor: "#f2f2f2", px: 2, borderRadius: "10px 10px 10px 0px", borderBottom:"1px solid #ddd",  }}>
                <Grid2 container>
                    <Grid2 size={{ xs: 6, sm: 6, md: 3, lg: 9 }} sx={{ display: "flex", alignItems: "center" }}>
