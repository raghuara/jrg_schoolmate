...
import { ConsentFetchFetch, ConsentFetchFetchDradt, DeleteAllDraft, DeleteConsentForm, DeleteNewsApi, NewsFetch } from "../../../../Api/Api";
...
export default function ConsentFormDraftPage() {
    const today = dayjs();
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
            const res = await axios.get(ConsentFetchFetchDradt, {
                params: {
            ...
            <Box sx={{ backgroundColor: "#f2f2f2", px: 2, borderRadius: "10px 10px 10px 0px",borderBottom:"1px solid #ddd", }}>
                <Grid container>
                    ...
                    <IconButton sx={{ width: "27px", height: "27px", marginTop: '2px' }}>
                        ...
                        <Typography sx={{ fontWeight: "600", fontSize: "20px" }} >Consent Forms Drafts</Typography>
                    </Grid>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "center", p: 2, backgroundColor: '#fff', }}>
                        <Box sx={{
                            ...
                            <Typography sx={{ fontSize: "20px" }}>Do you really want to make
                                changes to this consent form?</Typography>
                            <DialogActions sx={{
                                justifyContent: 'center',
                                backgroundColor: '#fff',
                                pt: 2
