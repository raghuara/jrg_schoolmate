...
export default function StudentInfoPage() {
    ...
    const handleEditClick = (id) => {
        navigate("/dashboardmenu/student/information/edit", { state: { id } });
    };
    ...
    const fetchAllData = async () => {
        ...
        try {
            ...
            setStudentNameEnglish(studentInfo?.[0]?.studentNameInEnglish || "")
            setStudentNameTamil(studentInfo?.[0]?.studentNameInTamil || "")
            setDateOfBirth(studentInfo?.[0]?.dateOfBirth || "")
                ...
                <Box sx={{ mt: 3, px: 2 }}>
                    ...
                    <Box sx={{ p: 2, border: "1px solid #0000001A", borderRadius: "5px", position: "relative" }}>
                        <Grid2 container spacing={2}>
                            <Grid2 size={{ xs: 12, md: 4.8, lg: 1.6 }} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                                <img
                            ...
                            <Grid2 size={{ xs: 12, md: 10, lg: 10.4 }}>
                                <Grid2 container >

                                    <Grid2 size={{ xs: 12, md: 4.8, lg: 2 }} sx={{ display: "flex", alignItems: "center", borderBottom: "1px dotted #0000005A", px: 2, py: 1, borderRight: "1px dotted #0000005A" }}>
                                        <Box>
                                            <Typography sx={{ color: "#B0B0B0", fontSize: "12px", }}>Student Name</Typography>
                                            <Typography sx={{ color: "#000", fontSize: "16px", py: 1 }}>{studentInfo?.[0]?.studentNameInEnglish}</Typography>
                                        </Box>
                                    </Grid2>
                                    ...
                                    <Grid2 size={{ xs: 12, md: 4.8, lg: 2 }} sx={{ display: "flex", alignItems: "center", px: 2, py: 1, borderBottom: "1px dotted #0000005A" }}>
                                        <Box>
                                    ...
                                    <Grid2 size={{ xs: 12, md: 4.8, lg: 2 }} sx={{ display: "flex", alignItems: "center", borderRight: "1px dotted #0000005A", px: 2, py: 1, }}>
                                        <Box>
                                    ...
                                    <Grid2 size={{ xs: 12, md: 4.8, lg: 2 }} sx={{ display: "flex", alignItems: "center", px: 2, py: 1, borderRight: "1px dotted #0000005A" }}>
                                        <Box>
                                    ...
                                    <Grid2 size={{ xs: 12, md: 4.8, lg: 2 }} sx={{ display: "flex", alignItems: "center", px: 2, pt: 1, borderRight: "1px dotted #0000005A", }}>
                                        <Box>
                                    ...
                                    <Grid2 size={{ xs: 12, md: 4.8, lg: 2.8 }} sx={{ display: "flex", alignItems: "center", px: 2, pt: 1 }}>
                                        <Box>
